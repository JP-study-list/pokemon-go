...
```
index.html            頁面骨架（只有容器，內容都由 JS 產生）
...
```js
{ id:"p068", no:888, art:888, gen:8, zh:"蒼響", ja:"ザシアン", en:"Zacian", cp20:null, cp25:null },
```
...
- XXS 尚未實際盤點，預設全部未取得
- 新增的 8 隻沒有 CP 數值（6 隻新傳說 + 熊徒弟兩型），顯示「未填」
- CP 目前只能看不能在畫面上編輯
- 地區背景欄位尚未實作
